...
export default function Palette({
  ...
  return (
    <div className="pointer-events-auto absolute inset-x-0 bottom-[3.75rem] top-auto z-10 flex max-h-[56%] flex-col rounded-t-xl bg-surface-container shadow-dialog sm:inset-x-auto sm:bottom-3 sm:left-3 sm:top-[9.75rem] sm:max-h-none sm:w-60 sm:max-w-[calc(100%-1.5rem)] sm:rounded-md sm:shadow-menu">
