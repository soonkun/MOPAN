...
const CATEGORIES: { id: string; title: string; summary: string; note?: string }[] = [
  ...
  },
  {
    id: "memory",
    title: "대화 기억",
    summary: "최근 턴 창 · 오래된 턴 요약 · 사용자 기억",
    note:
      "답변 모델은 최근 몇 턴을 원문으로, 그보다 오래된 대화는 대화마다 하나뿐인 요약으로 봅니다. " +
      "요약은 답변이 저장된 뒤 백그라운드에서 값싼 모델이 갱신하며, 어떤 이력이 실렸는지는 각 답변의 추적 화면에 기록됩니다. " +
      "'대화를 넘는 사용자 기억'은 계정별로 분리되어 그 사용자의 모든 대화에 실리고, 본인이 계정 창의 '내 기억'에서 보고 지웁니다.",
  },
  {
    id: "documents",
    title: "문서 관리",
